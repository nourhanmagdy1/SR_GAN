...
def content_loss(image_shape):
    def loss( y_true, y_pred):
        vgg19 = VGG19(include_top=False, input_shape=image_shape) #weights='/home/mohamed.rehan/Research/super_resolution/vgg19/vgg19_weights_tf_dim_ordering_tf_kernels_notop.h5'
